...
import { User, Trophy, Award, TrendingUp, Flame, Loader2, Calendar, AlertCircle } from 'lucide-react'
            ...
            <div className="border-b border-border/40 bg-background/50 backdrop-blur-sm">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-lg font-semibold text-foreground">{t('profile.pageTitle')}</h1>
                    </div>
                </div>
            </div>
